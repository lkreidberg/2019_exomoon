...
Similar to the findings of TK18, the moon model improved the fit quality by a $\Delta\chi^2 = 29.9$. Notably, however, the moon model fit to the TK18 data does not perform better than the no-moon model fit to our new data (rms of 362 versus 356 ppm), even with the additional seven free parameters.  %This difference in fit quality corresponds to $\Delta\mathrm{BIC} = 31.2$, which is strong evidence against the moon.  
...
\bibitem[{{Ning} {et~al.}(2018){Ning}, {Wolfgang}, \& {Ghosh}}]{ning18}
{Ning}, B., {Wolfgang}, A., \& {Ghosh}, S. 2018, \apj, 869, 5,
  \dodoi{10.3847/1538-4357/aaeb31}
